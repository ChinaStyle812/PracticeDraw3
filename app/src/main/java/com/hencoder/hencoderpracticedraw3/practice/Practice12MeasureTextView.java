...
public class Practice12MeasureTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float txtLen = paint1.measureText(text1, 0, text1.length());
        canvas.drawText(text2, 50 + txtLen, 200, paint2);
        txtLen += paint2.measureText(text2, 0, text2.length());
        canvas.drawText(text3, 50 + txtLen, 200, paint1);
    }
}
